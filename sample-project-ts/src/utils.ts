/**
 * Sample TypeScript utility functions for demonstrating AutoTypeScript type inference
 * These functions intentionally have no type annotations to test the extension's
 * ability to infer and add types.
 */

/**
 * Greets a user with optional formal style
 */
export function greet(name, age, options) {
 ...
 */
export function processNumbers(numbers, operation) {
  switch (operation) {
    case "sum":
 ...
 */
export function createTask(title, priority, assignee) {
  return {
