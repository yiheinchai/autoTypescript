...
- Fixed missing runtime dependencies (acorn, acorn-walk, astring) in packaged extension
- Changed activation event to `onStartupFinished` for reliable command availability
